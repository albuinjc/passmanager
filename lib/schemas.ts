...
export const credentialSchema = z.object({
    ...
    //two_fa_seed: (z.string().toUpperCase().regex(/^[A-Z2-7]*$/, "Invalid TOTP Seed (Base32 format required: A-Z, 2-7)").min(26, "TOTP Seed must be at least 26 characters (16 bytes)").optional().or(z.literal(""))),
